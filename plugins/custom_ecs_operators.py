...
from custom_ecs_hook import CustomEcsHook


class CheckEcsServiceOperator(BaseOperator):
    @apply_defaults
    def __init__(self, cluster_name, service_name, region_name, *args, **kwargs):
        super(CheckEcsServiceOperator, self).__init__(*args, **kwargs)
    ...
    def execute(self, context):
        ...
        try:
            response = hook.describe_service(self.cluster_name, self.service_name)
